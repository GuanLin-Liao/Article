...
<body>
  ...
  <main class="main-content p-3">
    ...
    <ul class="nav nav-underline ">
      <li class="nav-item ">
            <a class="nav-link <?php if(!isset($_GET["category"]) && !isset($_GET["search"])) echo "active"; ?>" href="dashboard.php">全部</a>
      </li>
      
      <?php foreach($cateRows as $category) : ?>
        <li class="nav-item">
            <a class="nav-link <?php if (isset($_GET["category"])&& $category_id == $category["id"]) echo "active"; ?>" href="dashboard.php?page=1&order=1&category=<?= $category["id"]?>"><?= $category["name"]?>
            </a>
